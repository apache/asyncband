...
* Rename the `mpsc` Cargo feature to `dispatch`; the public `asyncband::mpsc` path is unchanged, while the feature now names the competing-delivery channel family rather than one endpoint topology.
