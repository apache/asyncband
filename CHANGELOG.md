...
* Add `event::AutoResetEvent`, a reusable signal that releases one waiter, retains at most one unassigned signal, and transfers assigned signals when waits are cancelled.
