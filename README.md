...
|                       | [`ManualResetEvent`](https://docs.rs/asyncband/*/asyncband/event/struct.ManualResetEvent.html) | `event`        | Reuse a level-triggered signal that releases all current waiters.                                      |
