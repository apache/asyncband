...
- `waitgroup::WaitGroup` is inspired by [`waitgroup-rs`](https://github.com/laizy/waitgroup-rs), but treats every cloned handle as an RAII worker and supports cancellable multi-observer waits.
